    ...
    <footer class="site-footer">
      <div class="footer-grid section-shell">
        <div class="footer-brand">
          ...
          <p>Framework modern untuk membangun aplikasi web yang cepat, efisien, dan AI-friendly.</p>
          <div class="socials">
...
export function Cta() {
  return <section class="cta section-shell" id="get-started"><div><h2>Siap membangun sesuatu<br />yang luar biasa?</h2><p>Mulai project Anda dengan CocoFrame sekarang juga.</p></div><div class="cta-actions"><a class="button button-light" href="/docs#quick-start">Get Started <span aria-hidden="true"><ArrowRightIcon size={17} /></span></a><a class="button button-outline-light" href="/docs">View Documentation</a></div></section>;
}
