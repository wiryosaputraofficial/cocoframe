...
export default definePage({
  meta: {
    ...
    description: "Referensi 97 komponen responsif @cocoframe/ui dan 1.246 Solar Linear icons typed, lengkap dengan props, preview, accessibility, serta contoh penggunaan.",
  ...
  view: () => <main id="top" class="docs-layout components-layout">
    ...
    <div class="docs-content components-content">
      ...
      <section class="component-doc-panel" id="theming"><header><span class="eyebrow">THEMING</span><h2>Light, dark, and system themes</h2><p>Gunakan komponen <code>Theme</code> dengan nilai <code>light</code>, <code>dark</code>, atau <code>system</code>. Seluruh semantic token, native color-scheme, reduced motion, dan forced-colors tetap konsisten; token CSS masih dapat dioverride dari aplikasi.</p></header><SyntaxHighlighter code={themeCode} language="css" label="Contoh theme CSS CocoFrame" /></section>
