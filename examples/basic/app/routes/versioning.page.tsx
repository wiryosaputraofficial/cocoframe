...
export default definePage({
  ...
  view: () => <main class="project-page" id="top">
    ...
    <section class="project-release section-shell reveal" aria-label="Current CocoFrame release status">
      <div><span>Current workspace</span><strong>0.0.1</strong></div><div><span>Lifecycle</span><strong>Architectural MVP</strong></div><div><span>Public registry</span><strong>Not published yet</strong></div><div><span>Compatibility</span><strong>Explicit per release</strong></div>
    </section>
