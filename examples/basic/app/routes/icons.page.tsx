...
export default definePage({
  ...
  meta: ({ search, visibleCount }) => ({
    ...
    description: "Jelajahi 1.246 Solar Linear icons typed dan server-first untuk CocoFrame, lengkap dengan direct import, accessibility, styling, dan pencarian.",
  ...
  view: ({ search, icons, visibleCount, selected }) => <main class="icons-page" id="top">
    <section class="icons-hero section-shell">
      <div><span class="eyebrow pill">SOLAR LINEAR ICONS</span><h1>1.246 icons.<br /><span>One predictable API.</span></h1><p>Icon library lengkap untuk web CocoFrame. Semua ikon typed, mengikuti <code>currentColor</code>, dirender di server, dan tidak memerlukan JavaScript browser.</p><div class="icons-hero-actions"><a class="button button-primary" href="#icon-catalog">Browse all icons</a><a class="button button-ghost" href="#usage">How to use</a></div></div>
    ...
    <section class="icons-usage section-shell" id="usage" aria-labelledby="icons-usage-title">
      <header><span class="eyebrow">USAGE</span><h2 id="icons-usage-title">Import only what you use</h2><p>Gunakan direct subpath pada aplikasi agar hanya ikon yang dipakai masuk ke bundle. Aggregate catalog ditujukan untuk dokumentasi dan tooling seperti halaman ini.</p></header>
    ...
    <section class="icons-catalog" id="icon-catalog" aria-labelledby="icon-catalog-title">
      ...
      <div class="icons-empty icons-live-empty" hidden={visibleCount > 0}><h2>Icon tidak ditemukan</h2><p>Coba kata yang lebih pendek seperti <code>arrow</code>, <code>user</code>, <code>home</code>, atau <code>chart</code>.</p><a class="button button-primary" href="/icons#icon-catalog">Show all icons</a></div>
