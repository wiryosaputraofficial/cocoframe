...
const items = [
  ...
  [StarsMinimalisticIcon, "AI-Ready", "Purpose-built for AI integration and development automation.", ["CocoSpecs + CocoRef + CocoQA", "Low-token context", "Inspectable manifest"]],
...
export default definePage({
  meta: { title: "Features — CocoFrame", description: "CocoFrame features for fast, scalable, secure, SEO-friendly, and AI-ready web applications with CocoSpecs discovery and CocoRef reference approval.", canonical: "https://cocoframe.dev/features", image: "/assets/cocoframe-hero-isometric.png" },
  view: () => <main id="top">
