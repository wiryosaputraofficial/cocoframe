...
export default definePage({
  ...
  view: () => <main id="top">
    ...
    <div class="lifecycle-feature-list section-shell">
      <section class="cocospecs-feature reveal"><span aria-hidden="true"><StarsMinimalisticIcon size={29} /></span><div><h2>Meet CocoSpecs</h2><p>Give AI one feature request, answer a small adaptive question batch, and receive a complete PRD, flowchart, database proposal, acceptance criteria, and approved implementation plan.</p></div><a class="button" href="/cocospecs">Explore CocoSpecs <ArrowRightIcon size={16} /></a></section>
      <section class="cocospecs-feature reveal"><span aria-hidden="true"><GalleryIcon size={29} /></span><div><h2>Meet CocoRef</h2><p>Give AI an image or website, audit your existing component system, and preview every missing candidate through a consent and approval loop before it enters the application.</p></div><a class="button" href="/cocoref">Explore CocoRef <ArrowRightIcon size={16} /></a></section>
      <section class="cocospecs-feature reveal"><span aria-hidden="true"><ChecklistIcon size={29} /></span><div><h2>Meet CocoQA</h2><p>Turn approved requirements into adaptive quality decisions, traceable Product Design Quality cases, automated gates, defect evidence, and explicit release approval.</p></div><a class="button" href="/cocoqa">Explore CocoQA <ArrowRightIcon size={16} /></a></section>
      <section class="cocospecs-feature reveal"><span aria-hidden="true"><CodeSquareIcon size={29} /></span><div><h2>Connect through Agent Bridge</h2><p>Let supported AI clients discover and reuse CocoFrame capabilities, prepare approved lifecycles, and apply exact file changes only through expiring, role-aware, hash-bound human approval.</p></div><a class="button" href="/docs/agent-bridge">Explore Agent Bridge <ArrowRightIcon size={16} /></a></section>
    </div>
