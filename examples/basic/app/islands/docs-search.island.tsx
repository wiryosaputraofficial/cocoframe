...
const cards = [
  [BranchingPathsUpIcon, "Getting Started", "Clone GitHub, project creator, installation, struktur project, konfigurasi, dan quick start.", "getting started github clone repository create creator scaffolder installation quick start structure configuration", "#installation"],
