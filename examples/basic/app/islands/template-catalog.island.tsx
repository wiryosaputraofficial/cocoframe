...
const templates: readonly TemplateItem[] = [
  { slug: "starter", name: "CocoFrame Starter", description: "Fondasi minimal server-first dengan typed API dan counter island.", category: "Starter Kits", technology: ["TypeScript", "CocoFrame"], components: ["Badge", "Button", "Card", "Heading", "Stack", "Text"], icons: ["box-minimalistic", "code-square"], popularity: 100, badge: "Official" },
  { slug: "marketing", name: "Marketing Launch", description: "Landing page SEO-ready dengan hero, feature cards, metrics, dan CTA.", category: "Web Applications", technology: ["TypeScript", "CocoFrame", "CSS"], components: ["Badge", "Card", "Container", "Heading", "Inline", "Stack", "Stat", "Text"], icons: ["arrow-right", "bolt", "graph-up", "shield-check", "stars-minimalistic"], popularity: 98, badge: "Popular" },
  { slug: "dashboard", name: "Orbit Dashboard", description: "Dashboard admin responsif dengan sidebar, analytics, data table, dan status.", category: "Dashboards", technology: ["TypeScript", "CocoFrame", "Charts"], components: ["Badge", "Card", "Chart", "DataTable", "Heading", "Inline", "Sidebar", "Stat", "Text"], icons: ["bell", "calendar", "graph-up", "home", "magnifier", "settings", "users-group-rounded", "widget-4"], popularity: 96, badge: "Popular" },
  { slug: "documentation", name: "Atlas Documentation", description: "Dokumentasi server-first dengan sidebar, code samples, alert, dan route table.", category: "Documentation", technology: ["TypeScript", "CocoFrame"], components: ["Alert", "Badge", "Card", "Heading", "Sidebar", "SyntaxHighlighter", "Table", "Text"], icons: ["arrow-right", "book-2", "check-circle", "code-square", "document-text", "magnifier", "routing-2", "settings"], popularity: 92, badge: "New" },
];
      ...
      return <section class="template-browser section-shell" id="catalog">
        ...
        <div class="template-layout">
          <aside class="template-filters" aria-label="Template filters">
            ...
            <div class="submit-template"><BoxIcon size={24} /><h3>Source tersedia</h3><p>Semua template berada di repository dan diuji pada setiap perubahan.</p><a href="https://github.com/wiryosaputraofficial/cocoframe/tree/main/packages/create-cocoframe" target="_blank" rel="noreferrer">View source <ArrowRightIcon size={14} /></a></div>
          </aside>

          <div class="template-results">
            <div class="template-result-summary" role="status"><strong>{filtered.length}</strong> template siap dibuat dari npm</div>
            {filtered.length ? <div class="template-grid">{filtered.map((item) => <TemplateCard item={item} open={() => { openTemplate(item); }} />)}</div> : <div class="template-empty"><Heading level={2} size="medium">Tidak ada template yang cocok</Heading><Text tone="muted">Coba kata kunci atau filter lain.</Text><Button size="small" onClick={resetFilters}>Reset filters</Button></div>}
          </div>
        </div>
