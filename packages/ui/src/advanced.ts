...
/**
 * Renders the Accordion server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Alert Dialog server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Aspect Ratio server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Attachment server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Bubble server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Button Group server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Calendar server-first UI primitive with semantic markup and no required browser runtime.
 */
export function Calendar({ id, year, month, selected, weekdayLabels = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], class: className }: CalendarProps): CocoNode {
  ...
  return jsx("section", { class: classes("coco-calendar", className), "aria-label": `${year}-${String(month).padStart(2, "0")}`, children: [jsx("header", { children: jsx("strong", { children: new Intl.DateTimeFormat("en-US", { month: "long", year: "numeric", timeZone: "UTC" }).format(first) }) }), jsx("div", { class: "coco-calendar__weekdays", children: weekdayLabels.map((label) => jsx("span", { children: label })) }), jsx("div", { class: "coco-calendar__grid", children: cells })] });
}
...
/**
 * Renders the Carousel server-first UI primitive with semantic markup and no required browser runtime.
 */
export function Carousel({ id, items, label = "Carousel", class: className }: CarouselProps): CocoNode { return jsx("section", { class: classes("coco-carousel", className), "aria-roledescription": "carousel", "aria-label": label, children: [jsx("div", { class: "coco-carousel__track", children: items.map((item, index) => jsx("article", { id: `${id}-${item.id}`, class: "coco-carousel__slide", "aria-label": item.label ?? `${index + 1} of ${items.length}`, children: item.content })) }), jsx("nav", { "aria-label": "Carousel slides", children: items.map((item, index) => jsx("a", { href: `#${id}-${item.id}`, "aria-label": `Go to slide ${index + 1}`, children: index + 1 })) })] }); }

export interface CollapsibleProps extends ClassProps { readonly summary: string; readonly open?: boolean; }
/**
 * Renders the Collapsible server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Combobox server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Command server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Context Menu server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Data Table server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Date Picker server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Direction server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Hover Card server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Input Otp server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Item server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Kbd server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Label server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Marker server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Menubar server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Message server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Message Scroller server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Navigation Menu server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Popover server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Questionnaire server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Resizable server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Scroll Area server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Sidebar server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Slider server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Toggle server-first UI primitive with semantic markup and no required browser runtime.
 */
...
/**
 * Renders the Toggle Group server-first UI primitive with semantic markup and no required browser runtime.
 */
