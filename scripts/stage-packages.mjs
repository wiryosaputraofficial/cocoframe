...
const descriptions = {
  ...
  "@cocoframe/cocoref": "Reference-driven component auditing, consent, preview, revision, and approval for CocoFrame.",
  ...
  "@cocoframe/qa": "Adaptive, traceable quality planning, evidence, defects, gates, and release approval for CocoFrame.",
