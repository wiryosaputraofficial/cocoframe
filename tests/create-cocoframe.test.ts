...
import { parseArguments, scaffoldProject } from "../packages/create-cocoframe/src/index.js";
import { buildProject, discoverIslands, discoverRoutes } from "../packages/cli/src/project.ts";
